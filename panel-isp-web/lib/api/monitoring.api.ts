...
import type { MonitoringOverview, PelangganKoneksiOverview, PerangkatBaruResult } from '@/lib/types';
...
export async function getPerangkatBaru(): Promise<PerangkatBaruResult> {
    const res = await apiClient.get<PerangkatBaruResult>('/monitoring/perangkat-baru', {
        timeout: 25000,
    });
    return res.data;
}
